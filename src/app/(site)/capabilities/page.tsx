  ...
  return (
    <div className="w-full overflow-x-clip">
                ...
                <MediaReveal key={index} delay={index * 100} intensity="medium">
                  ...
                  >
                    ...
                    <CardHeader className="relative z-10 text-center">
                      <div className="w-12 h-12 rounded-lg bg-[var(--brand-primary)]/5 flex items-center justify-center mx-auto mb-4 group-hover:bg-[var(--brand-primary)]/10 transition-colors duration-200 ease-out motion-reduce:transition-none">
        ...
        <Container>
          <MediaReveal intensity="subtle">
            <div className="mb-12 md:mb-16">
              ...
              <p className="text-base md:text-lg text-[var(--brand-fg)]/80 leading-relaxed max-w-3xl">
                ...
                >
                  ...
                  <CardHeader className="relative z-10 flex-shrink-0 md:w-48 pb-4 md:pb-6">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-lg bg-[var(--brand-primary)]/5 flex items-center justify-center text-[var(--brand-primary)] font-bold text-lg">
                        {step.step}
                      </div>
                      <div>
                        <CardTitle className="text-lg md:text-xl font-bold text-[var(--brand-fg)] mb-1">
                  ...
                  <CardContent className="relative z-10 flex-1 flex flex-col md:flex-row gap-6 pt-0 min-w-0">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[var(--brand-fg)]/80 leading-relaxed break-words min-w-0">
                        {step.deliverables}
                      </p>
                    </div>
                    <div className="flex-1 min-w-0">
                  ...
                  <CardHeader className="relative z-10">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={cn(
                        ...
                        phase.status === "예정" && "bg-black/5 text-black/40"
                      )}>
                        {phase.status}
                      </span>
                    </div>
                ...
                >
                  ...
                  <CardContent className="relative z-10 mt-auto pt-0">
                    <div className="flex items-center justify-between pt-4 border-t border-[var(--brand-muted)]">
                      ...
                      <span className="text-xs font-medium px-2 py-1 rounded-full bg-[var(--brand-primary)]/5 text-[var(--brand-fg)]/60">
                        {deliverable.status}
                      </span>
                    </div>
                  </CardContent>
      ...
      <Section
        ...
        divider="top"
        minHeight="auto"
        className="py-20 md:py-24 bg-[#050505]"
      >
        <Container>
          <MediaReveal intensity="subtle">
