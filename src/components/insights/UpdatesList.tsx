        ...
        <Link key={update.id} href={update.href} className="block w-full min-w-0">
          ...
          >
            ...
            <div className="p-6 pl-0 sm:pl-6 flex-shrink-0">
              <ArrowRight className="w-5 h-5 text-[var(--brand-fg)]/40 group-hover:text-[var(--brand-primary)] transition-colors duration-200 ease-out motion-reduce:transition-none" />
            </div>
          </Card>
        </Link>
      ))}
